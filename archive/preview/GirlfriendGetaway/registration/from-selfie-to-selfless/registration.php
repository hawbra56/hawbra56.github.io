...
if ($DateVenue == 'October 24, 2015 / Eden Resort, Lancaster, PA'){
		header("Location: 2015-10-24/");
		exit;
	}
if ($DateVenue == 'April 16, 2016 / Crossroad Community Church, Georgetown, DE'){
		header("Location: 2016-04-16/");
		exit;
	}
