...
if ($DateVenue == 'September 16-17, 2011 / Ramada Conference Center, Altoona, PA'){
		header("Location: 2011-09-12/");
		exit;
	}
if ($DateVenue == 'October 28-29, 2011 / Shawnee Inn, Poconos, PA'){
		header("Location: 2011-10-28/");
		exit;
	}
if ($DateVenue == 'November 11-12, 2011 / Eden Resort, Lancaster, PA'){
		header("Location: 2011-11-11/");
		exit;
	}
	
if ($DateVenue == 'March 23-24, 2012 / Hilton Garden Inn, North Alpharetta, GA'){
		header("Location: 2012-03-23/");
		exit;
	}
if ($DateVenue == 'April 13-14, 2012 / Double Tree, Pittsburgh, PA (Monroeville)'){
		header("Location: 2012-04-13/");
		exit;
	}
