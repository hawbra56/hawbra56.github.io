...
if ($DateVenue == 'November 8, 2014 / Eden Resort, Lancaster, PA'){
		header("Location: 2014-11-08/");
		exit;
	}
if ($DateVenue == 'April 11, 2015 / Crossroad Community Church, Georgetown, DE'){
		header("Location: 2015-04-11/");
		exit;
	}
