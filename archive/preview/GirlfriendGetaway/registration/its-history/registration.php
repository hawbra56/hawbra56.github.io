...
if ($DateVenue == 'September, 2012 / Washington DC'){
		header("Location: 2012-09-01/");
		exit;
	}
	
if ($DateVenue == 'October 5-6, 2012 / Wyndham Garden, Washington, DC'){
		header("Location: 2012-10-05/");
		exit;
	}
	
if ($DateVenue == 'November 2-3, 2012 / Shawnee Inn, Poconos, PA'){
		header("Location: 2012-11-02/");
		exit;
	}
if ($DateVenue == 'November 16-17, 2012 / Eden Resort, Lancaster, PA'){
		header("Location: 2012-11-16/");
		exit;
	}
if ($DateVenue == 'April 26-27, 2013 / Four Points Sheraton, Mars, PA'){
		header("Location: 2013-04-26/");
		exit;
	}
